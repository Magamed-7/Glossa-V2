...
class GrammarLessons(Base):
    ...
    tip_en: Mapped[str | None] = mapped_column(String, nullable=True)
    tip_ru: Mapped[str | None] = mapped_column(String, nullable=True)
    tip_tg: Mapped[str | None] = mapped_column(String, nullable=True)
