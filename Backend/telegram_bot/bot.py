...
async def main():
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="balance", description="Check balance and top up via bank card"),
        BotCommand(command="subscribe", description="Browse and pay for subscription plans"),
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="balance", description="Баланс и пополнение через карту"),
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="balance", description="Баланс ва пуркунӣ тавассути корт"),
        BotCommand(command="subscribe", description="Пардохти тариф"),
