      ...
      <table className="w-full border-collapse">
        ...
        <thead>
          <tr className="border-b-2 border-tertiary">
            <th scope="col" className="text-left py-3 font-label text-label-md uppercase">Rank</th>
            <th scope="col" className="text-left py-3 font-label text-label-md uppercase">Learner</th>
            <th scope="col" className="text-right py-3 font-label text-label-md uppercase">Score</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((entry, i) => (
            ...
            >
              ...
              <td className="py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-body">{entry.username || "—"}</span>
                </div>
              </td>
          ...
          {myEntry && !myRowIncluded && (
            <tr className="border-b border-surface-container-highest bg-secondary-container text-on-secondary-container">
              <td className="py-3 font-ledger">{myEntry.rank ?? "—"}</td>
              <td className="py-3 font-body">You</td>
