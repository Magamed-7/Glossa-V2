export const en = {
  ...
  pricing: {
    ...
    plans: {
      free: {
        ...
        locked: ["AI Tutor conversations", "Buying stories in the Marketplace", "Telegram bot access"],
      },
      premium: {
        name: "Scholar",
  ...
  settings: {
    ...
    telegram: {
      ...
      connectedDesc: "Your profile is actively linked to Glossa Telegram bot.",
      activeBadge: "ACTIVE / VERIFIED",
      languageLabel: "Bot Interface Language",
      languageDescCustom: "Custom Telegram locale overrides main language.",
      languageDescDefault: "Defaults to your main profile language.",
      sm2Label: "Spaced Repetition (SM-2) Notifications",
      sm2Desc: "Receive reminders tailored specifically to your spaced repetition queue.",
      unlinkButton: "Disconnect Telegram",
      unlinkConfirm: "Are you sure you want to disconnect your Telegram account?",
      successUnlinked: "Telegram account successfully disconnected.",
    },
    account: {
