export const en = {
  ...
  errors: {
    ...
    LEVEL_NOT_UNLOCKED: "This content is above your unlocked level.",
    STORY_NOT_READ: "Read the story before taking its test.",
    AUDIOBOOK_LIMIT_REACHED: "You've reached today's audiobook limit — upgrade your plan for more.",
    STORY_AUDIO_NOT_AVAILABLE: "Audio isn't ready for this story yet — try again shortly.",
  },
  loadingScreen: {
    brand: "Glossa",
  },
  ...
  auth: {
    ...
    login2fa: {
      ...
      checkEmailNotice: "We sent a code to your email — enter it below.",
  ...
  deck: {
    ...
    games: {
      ...
      restoresUsed: "Restores used this month: {used} of {max}",
      restoresRemaining: "Restores remaining: {n}",
      restoreSuccess: "Daily streak successfully restored!",
      streakActive: "Your daily streak is active!",
      streakBroken: "Your daily streak is broken!",
      upgradeToGetMore: "Upgrade your subscription tier to get more restores.",
      operationalLogSecure: "OPERATIONAL LOG: SECURE",
      due: "DUE",
      streakRestorationTitle: "Streak Restoration",
      upgradeSubscription: "Upgrade Subscription →",
      noMissions: "No missions available",
      agentInterface: "Glossa HQ / Agent Interface",
  ...
  stories: {
    ...
    listenAudiobook: "Listen to audiobook",
  ...
  tutor: {
    ...
    scenarios: {
      interview: { title: "Job Interview", description: "Practise sounding confident and competent under friendly professional questions." },
      casual: { title: "Random Chat", description: "Easy small talk about everyday life — no pressure, just conversation." },
      restaurant: { title: "At the Restaurant", description: "Order, ask questions, and handle the bill like a regular at a good place." },
      airport: { title: "At the Airport", description: "Check in, get through security, and find your gate in real travel phrases." },
      telegram: { title: "Telegram Chat", description: "Short, casual messages you can practise with in a spare minute." },
      shopping: { title: "Market Haggling", description: "Browse, ask prices, and try to bargain your way to a good deal." },
      doctor: { title: "Doctor's Appointment", description: "Describe how you feel and understand the advice you get back." },
      debate: { title: "Friendly Debate", description: "Defend a fun opinion and push back on someone else's — all in good spirit." },
      adventure: { title: "Story Adventure", description: "Choose your own path through a short mystery you help write yourself." },
      newfriend: { title: "Making a New Friend", description: "Talk about what you actually like — hobbies, music, plans, dreams." },
    },
  ...
  leaderboard: {
    ...
    titleLead: "Registry of",
    titleAccent: "Excellence",
    subtitle: "The foremost linguistic scholars and their standing within the Glossa academy. Compete for editorial mastery.",
    allTime: "All Time",
    thisWeek: "Weekly",
    ...
    nextRank: "Next Rank",
    viewMissions: "View Pending Missions",
    loadMore: "Load Further Archives",
  ...
  pricing: {
    ...
    titleAccent: "Fluency",
    subtitle: "Every plan gets the full Roadmap, Grammar Hub and Practice Tests — start to finish. The difference is how much of the world, and how much of the AI Tutor, you get to explore each day.",
    includedTitle: "Included on every plan, always",
    includedItems: [
      "Full Roadmap — A1 through C2, unit and level tests included",
      "Grammar Hub — every topic, always in order",
      "Practice Tests — build your own from any topic, word or story",
      "Spaced-repetition word deck",
      "Leaderboard, streaks and achievements",
      "Browse the full story catalog and the Marketplace",
    ],
    monthly: "Monthly",
    ...
    billedHalfYearly: "{price} billed every 6 months",
    feature: "Feature",
    plans: {
      free: {
        name: "Initiate",
        tagline: "Everything you need to start — no card required.",
        cta: "Start Free",
        features: [
          "Read 5 stories a day",
        ...
        locked: [
          ...
          "AI story generation from your own words",
          "Auto pronunciation transcription for your words",
          "Buying stories in the Marketplace",
          "Telegram bot access",
        ],
      },
      premium: {
        name: "Scholar",
        tagline: "For learners who show up daily and want the AI Tutor in their corner.",
        cta: "Go Scholar",
        features: [
          "Unlimited story reading",
          "Unlimited new words in your deck",
          "55 ready-made vocabulary words a day",
          "Publish up to 12 of your own stories a week",
          "AI Tutor — 2.5 hours a day, all 10 roles",
          "AI-generated personal stories — up to 12 a day, built from your own words",
      ...
      pro: {
        name: "Archivist",
        tagline: "No caps, no clock — for learners who want to disappear into the language.",
        cta: "Go Archivist",
        features: [
          "Unlimited story reading",
          "Unlimited new words in your deck",
          "Unlimited ready-made vocabulary",
          "Publish up to 50 of your own stories a week",
          "AI Tutor — unlimited conversation, every role, every day",
          "Unlimited AI-generated personal stories from your own words",
    ...
    rows: {
      ...
      readyVocab: "Ready-made vocabulary",
      ownStoriesPerWeek: "Own stories per week",
      generatedStoriesPerDay: "AI-generated stories per day",
      aiPerDay: "AI Tutor conversation per day",
      audioWordsPerDay: "Pronunciation for your own words",
      transcription: "Auto pronunciation transcription",
      audiobooksPerDay: "Audiobooks per day",
    ...
    audioWordsByPlan: { free: "5 total", premium: "50 / day", pro: "Unlimited" },
    transcriptionByPlan: { free: "5 total", premium: "50 / day", pro: "Unlimited" },
    subscribed: "You're now on the {code} plan!",
    currentPlan: "Current Plan",
    choose: "Choose {code}",
    confirmTitle: "Confirm purchase",
    confirmBody: "Subscribe to {code} for {price} — this will be deducted from your wallet balance. Continue?",
    confirmYes: "Yes, subscribe",
    confirmNo: "Cancel",
  },
  profile: {
    followers: "Followers",
    ...
    authoredStories: "Stories by this author",
    friends: "Friends",
    ...
    unfollow: "Following",
    message: "Message",
    previewPublic: "View as others see it",
    languages: "Languages",
    ...
    privacy: {
      ...
      services: { label: "Services Offered", description: "Tutor and language help services you offer." },
      books: { label: "Published Books", description: "Books and stories you've written." },
      subscription: { label: "Subscription tier", description: "Whether to display your premium status (PRO/PREMIUM)." },
    },
  ...
  settings: {
    ...
    telegram: {
      requiresPlan: "Linking Telegram requires a Pro or Premium subscription.",
      viewPlans: "View Plans",
      link: "Link Telegram Account",
      connected: "Telegram Bot Linked",
      connectedDesc: "Your Glossa account is successfully connected to our official bot.",
      activeBadge: "Connected",
      languageLabel: "Bot Interaction Language",
      languageDescCustom: "The bot will send messages in your chosen language.",
      languageDescDefault: "Defaults to your profile's interface language.",
      sm2Label: "Spaced Repetition Reminders",
      sm2Desc: "Receive daily reminders about words ready for review.",
      unlinkButton: "Unlink Telegram",
      unlinkConfirm: "Are you sure you want to unlink your Telegram account?",
      successUnlinked: "Telegram account successfully unlinked.",
    },
    account: {
      ...
      checkNewEmailNotice: "We sent a code to {email} — enter it below to confirm this is your address.",
      changeAvailableIn: "You can change this again in {days} day(s).",
      save: "Save",
      ...
      twoFactorDescription: "Add a second layer of verification with a code sent to your email, so a leaked password alone can't get anyone into your account.",
      checkEmailNotice: "We sent a code to your email — enter it below to confirm.",
      sendCode: "Send code",
      cancel: "Cancel",
  ...
  wallet: {
    ...
    topUp: "Top Up",
    topUpViaBotHint: "Top-ups go through our Telegram bot: you'll pick an amount there and get a card number to transfer to.",
    topUpViaBotButton: "Top up via Telegram bot",
    analyticsTitle: "Analytics",
    totalTopUps: "Total topped up",
    totalSpent: "Total spent",
    byCategory: "By category",
    type_topup: "Balance Top-up",
    type_subscription: "Plan purchase",
  ...
  messenger: {
    ...
    startOne: "Start one with a friend to see it here.",
    noFriendsYet: "Follow each other with someone first to start a conversation.",
    pickConversation: "Select a conversation",
    pickConversationDesc: "Choose someone from the list, or start a new conversation.",
    someone: "Someone",
  ...
  people: {
    title: "People",
    subtitle: "Find and follow other Glossa learners.",
    searchPlaceholder: "Search by username",
    noResults: "No one found",
    noResultsDesc: "Try a different username.",
  },
};
