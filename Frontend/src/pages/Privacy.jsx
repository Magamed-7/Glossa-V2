...
export default function Privacy() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-margin-mobile md:px-margin-desktop pt-16 md:pt-20 pb-section-gap">
      <PageHeader eyebrow={t("legal.privacy.eyebrow")} title={t("legal.privacy.title")} accent={t("legal.privacy.accent")} />
      <p className="font-label text-label-md uppercase tracking-widest text-on-surface-variant mb-12">{t("legal.privacy.updated")}</p>
